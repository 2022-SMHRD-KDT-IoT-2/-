...
<body>
			...
			<table class="board_table">
				...
				<tr>
					...
					<td>
						...
						<a class="list-a"
						href="productcontent.jsp?no=<%=board.getProduct_seq()%>&pageNum=<%=currentPage%>&sel=<%=sel%>&find=<%=find%>"><%=board.getUser_id()%></a>
					</td>
				</tr>
				<%
				}
				...
				<td colspan="6" align="center">
					...
					%> <a class="list-a"
					href="productlist.jsp?pageNum=<%=startPage - 10%>">[이전]</a> <%
 }
 ...
 %> <a class="list-a" href="productlist.jsp?pageNum=<%=i%>">[<%=i%>]
				</a> <%
 }
 } // for end
 ...
 %> <a class="list-a" href="productlist.jsp?pageNum=<%=startPage + 10%>">[다음]</a>
					...
					%> <a
					href="productlist.jsp?pageNum=<%=startPage - 10%>&sel=<%=sel%>&find=<%=find%>">[이전]</a>
					<%
					}
					...
					%> <a href="productlist.jsp?pageNum=<%=i%>&sel=<%=sel%>&find=<%=find%>">[<%=i%>]
				</a> <%
 }
 }
 ...
 if (endPage < pageCount) {
 %> <a
					href="productlist.jsp?pageNum=<%=startPage + 10%>&sel=<%=sel%>&find=<%=find%>">[다음]</a>
					<%
					}
					}
					%>
				...
				<tr>
					<td colspan="6" align="right">
						...
						class="list-button" value="제품 추가"
						onclick="location.href='productrequest.jsp'">
					</td>
				</tr>
				<tr>
					<%
